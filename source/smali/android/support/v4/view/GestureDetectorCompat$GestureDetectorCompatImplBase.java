...
a=0;//     :cond_0
a=0;//     :goto_0
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Boolean);v3=(Integer);v4=(Conflicted);v5=(Conflicted);v6=(Conflicted);v7=(Conflicted);
a=0;//     return v2
a=0;// 
a=0;//     .line 443
a=0;//     :cond_1
a=0;//     #v0=(Uninit);v1=(Uninit);v2=(Null);v3=(Boolean);v4=(Uninit);v5=(Uninit);v6=(Uninit);v7=(Uninit);
...
a=0;// 
a=0;//     #v36=(Reference,Landroid/view/VelocityTracker;);
...
a=0;//     .local v18, "i":I
a=0;//     :goto_2
a=0;//     #v0=(Conflicted);v1=(Integer);v18=(Integer);v26=(Float);v27=(Float);
...
a=0;//     :cond_1
a=0;//     #v0=(Integer);v1=(PosByte);v7=(Uninit);v18=(Uninit);v22=(Uninit);v25=(Uninit);v26=(Uninit);v27=(Uninit);
...
a=0;//     :cond_3
a=0;//     #v1=(Integer);v7=(Integer);v18=(Integer);v25=(Integer);v26=(Float);v27=(Float);
...
a=0;//     :goto_5
a=0;//     :pswitch_0
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v4=(Conflicted);v8=(Conflicted);v9=(Conflicted);v10=(Conflicted);v11=(Conflicted);v13=(Conflicted);v16=(Conflicted);v17=(Boolean);v19=(Conflicted);v20=(Conflicted);v21=(Conflicted);v23=(Conflicted);v24=(Conflicted);v28=(Conflicted);v29=(Conflicted);v30=(Conflicted);v31=(Conflicted);v32=(Conflicted);v33=(Conflicted);v34=(Conflicted);v35=(Conflicted);v36=(Conflicted);v37=(Conflicted);v38=(Conflicted);v39=(Conflicted);v40=(Conflicted);v41=(Conflicted);
a=0;//     return v17
a=0;// 
...
a=0;//     :cond_6
a=0;//     #v0=(Integer);v1=(Integer);v2=(Uninit);v3=(Uninit);v4=(Uninit);v8=(Uninit);v9=(Uninit);v10=(Uninit);v11=(Uninit);v12=(Uninit);v13=(Uninit);v14=(Uninit);v15=(Uninit);v16=(Uninit);v17=(Uninit);v19=(Uninit);v20=(Uninit);v21=(Uninit);v23=(Uninit);v24=(Uninit);v28=(Uninit);v29=(Uninit);v30=(Uninit);v31=(Uninit);v32=(Uninit);v33=(Uninit);v34=(Uninit);v35=(Uninit);v36=(Integer);v37=(PosByte);v38=(Uninit);v39=(Uninit);v40=(Uninit);v41=(Uninit);
a=0;//     move v12, v7
a=0;// 
a=0;//     .line 243
a=0;//     #v12=(Integer);
...
a=0;//     :pswitch_1
a=0;//     #v14=(Float);v15=(Float);v17=(Null);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
...
a=0;// 
a=0;//     :goto_6
a=0;//     #v0=(Conflicted);v13=(Conflicted);v20=(Conflicted);v32=(Conflicted);v34=(Conflicted);v36=(Conflicted);
a=0;//     move/from16 v0, v18
a=0;// 
a=0;//     #v0=(Integer);
...
a=0;//     :pswitch_3
a=0;//     #v0=(Integer);v13=(Uninit);v19=(Uninit);v20=(Uninit);v28=(Uninit);v32=(Uninit);v33=(Uninit);v34=(Uninit);v35=(Uninit);v36=(Integer);v37=(PosByte);v38=(Uninit);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
...
a=0;//     move-object/from16 v36, v0
a=0;// 
a=0;//     #v36=(Reference,Landroid/view/GestureDetector$OnDoubleTapListener;);
...
a=0;//     :cond_a
a=0;//     :goto_7
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v16=(Conflicted);v36=(Conflicted);v37=(Conflicted);v38=(Conflicted);v39=(Conflicted);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
a=0;//     iput v14, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mLastFocusX:F
...
a=0;//     move-object/from16 v36, v0
a=0;// 
a=0;//     #v36=(Reference,Landroid/os/Handler;);
...
a=0;// 
a=0;//     #v38=(Reference,Landroid/view/MotionEvent;);
...
a=0;//     .line 318
a=0;//     :cond_c
a=0;//     #v0=(Conflicted);v1=(Conflicted);v36=(Conflicted);v37=(Conflicted);v38=(Conflicted);v39=(Conflicted);v40=(Conflicted);v41=(Conflicted);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
a=0;//     iget-object v0, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mHandler:Landroid/os/Handler;
...
a=0;//     :cond_d
a=0;//     #v1=(Conflicted);v16=(Boolean);v17=(Null);v36=(Conflicted);v37=(Conflicted);v38=(Uninit);v39=(Uninit);v40=(Uninit);v41=(Uninit);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget-object v0, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mHandler:Landroid/os/Handler;
a=0;// 
...
a=0;//     .end local v16    # "hadTapMessage":Z
a=0;//     :pswitch_4
a=0;//     #v0=(Integer);v1=(Integer);v2=(Uninit);v3=(Uninit);v16=(Uninit);v36=(Integer);v38=(Uninit);v39=(Uninit);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
...
a=0;//     .line 331
a=0;//     :cond_e
a=0;//     #v0=(Boolean);v1=(Integer);v17=(Null);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
...
a=0;//     move-object/from16 v36, v0
a=0;// 
a=0;//     #v36=(Reference,Landroid/view/GestureDetector$OnGestureListener;);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     iget-object v0, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mCurrentDownEvent:Landroid/view/MotionEvent;
a=0;// 
...
a=0;//     .line 344
a=0;//     :cond_f
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v4=(Conflicted);v36=(Conflicted);v37=(Integer);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
a=0;//     iget v0, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mTouchSlopSquare:I
...
a=0;//     :cond_10
a=0;//     #v0=(Boolean);v1=(Integer);v2=(Uninit);v3=(Uninit);v4=(Uninit);v9=(Uninit);v10=(Uninit);v11=(Uninit);v17=(Null);v36=(Boolean);v37=(PosByte);
...
a=0;//     :pswitch_5
a=0;//     #v0=(Integer);v1=(Integer);v2=(Uninit);v3=(Uninit);v4=(Uninit);v17=(Null);v23=(Uninit);v24=(Uninit);v36=(Integer);v37=(PosByte);
a=0;//     const/16 v36, 0x0
a=0;// 
a=0;//     #v36=(Null);
a=0;//     move/from16 v0, v36
...
a=0;//     :cond_12
a=0;//     :goto_8
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v4=(Conflicted);v17=(Boolean);v21=(Conflicted);v29=(Conflicted);v30=(Conflicted);v31=(Conflicted);v36=(Conflicted);v37=(Conflicted);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
a=0;//     iget-object v0, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mPreviousUpEvent:Landroid/view/MotionEvent;
...
a=0;//     .line 394
a=0;//     :cond_14
a=0;//     #v0=(Reference,Landroid/view/VelocityTracker;);v1=(Conflicted);v36=(Reference,Landroid/view/VelocityTracker;);
a=0;//     const/16 v36, 0x0
a=0;// 
a=0;//     #v36=(Null);
a=0;//     move/from16 v0, v36
...
a=0;//     .line 360
a=0;//     :cond_15
a=0;//     #v0=(Boolean);v2=(Uninit);v3=(Uninit);v4=(Uninit);v17=(Null);v21=(Uninit);v29=(Uninit);v30=(Uninit);v31=(Uninit);v36=(Boolean);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
a=0;//     iget-boolean v0, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mInLongPress:Z
...
a=0;//     .line 370
a=0;//     :cond_17
a=0;//     #v0=(Boolean);v17=(Null);v36=(Boolean);
a=0;//     move-object/from16 v0, p0
a=0;// 
a=0;//     #v0=(Reference,Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;);
a=0;//     iget-object v0, v0, Landroid/support/v4/view/GestureDetectorCompat$GestureDetectorCompatImplBase;->mVelocityTracker:Landroid/view/VelocityTracker;
...
a=0;//     #v29=(Reference,Landroid/view/VelocityTracker;);
a=0;//     const/16 v36, 0x0
a=0;// 
a=0;//     #v36=(Null);
a=0;//     move-object/from16 v0, p1
...
a=0;//     :pswitch_6
a=0;//     #v0=(Integer);v1=(Integer);v2=(Uninit);v3=(Uninit);v4=(Uninit);v8=(Uninit);v17=(Null);v21=(Uninit);v29=(Uninit);v30=(Uninit);v31=(Uninit);v36=(Integer);v37=(PosByte);
