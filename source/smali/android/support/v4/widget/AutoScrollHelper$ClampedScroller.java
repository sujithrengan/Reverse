...
a=0;//     .line 794
a=0;//     :goto_0
a=0;//     #v0=(Conflicted);v1=(Conflicted);v2=(Conflicted);v3=(Conflicted);v4=(Float);v5=(Integer);v6=(Conflicted);v7=(Conflicted);v8=(Conflicted);v9=(Conflicted);
a=0;//     return v4
a=0;// 
a=0;//     .line 789
a=0;//     :cond_0
a=0;//     #v0=(Uninit);v1=(Uninit);v2=(Uninit);v3=(Uninit);v4=(Null);v5=(Byte);v6=(LongLo);v7=(LongHi);v8=(Uninit);v9=(Uninit);
...
a=0;//     :cond_2
a=0;//     #v2=(Uninit);v3=(Uninit);v4=(Null);v5=(Byte);v6=(LongLo);v7=(LongHi);
a=0;//     iget-wide v6, p0, Landroid/support/v4/widget/AutoScrollHelper$ClampedScroller;->mStopTime:J
a=0;// 
