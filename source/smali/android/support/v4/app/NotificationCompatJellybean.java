...
a=0;//     move-result-object v4
a=0;// 
a=0;//     iput-object v4, p0, Landroid/support/v4/app/NotificationCompatJellybean;->b:Landroid/app/Notification$Builder;
a=0;// 
a=0;//     .line 59
a=0;//     return-void
a=0;// 
...
a=0;// 
a=0;//     :cond_3
a=0;//     #v0=(Reference,Landroid/app/PendingIntent;);v4=(Integer);
a=0;//     const/4 v4, 0x0
a=0;// 
a=0;//     #v4=(Null);
a=0;//     goto :goto_3
