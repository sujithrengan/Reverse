...
a=0;// 
a=0;//     .line 142
a=0;//     #v2=(Reference,Landroid/support/v4/app/NotificationCompat$BigTextStyle;);
a=0;//     move-object/from16 v0, p1
a=0;// 
a=0;//     #v2=(Conflicted);
...
a=0;//     :cond_1
a=0;//     :goto_1
a=0;//     #v2=(Conflicted);v3=(Conflicted);v7=(Conflicted);v20=(Conflicted);
...
a=0;//     .line 147
a=0;//     :cond_2
a=0;//     #v2=(Boolean);v3=(Reference,Ujava/lang/Object;);v7=(Reference,Landroid/widget/RemoteViews;);v20=(Uninit);
a=0;//     move-object/from16 v0, p1
a=0;// 
a=0;//     iget-object v2, v0, Landroid/support/v4/app/NotificationCompat$Builder;->mStyle:Landroid/support/v4/app/NotificationCompat$Style;
a=0;// 
...
a=0;// 
a=0;//     .line 148
a=0;//     #v2=(Reference,Landroid/support/v4/app/NotificationCompat$InboxStyle;);
a=0;//     move-object/from16 v0, p1
a=0;// 
a=0;//     #v2=(Conflicted);
a=0;//     iget-object v0, v0, Landroid/support/v4/app/NotificationCompat$Builder;->mStyle:Landroid/support/v4/app/NotificationCompat$Style;
...
a=0;// 
a=0;//     .line 154
a=0;//     #v2=(Reference,Landroid/support/v4/app/NotificationCompat$BigPictureStyle;);
a=0;//     move-object/from16 v0, p1
a=0;// 
a=0;//     #v2=(Conflicted);
a=0;//     iget-object v0, v0, Landroid/support/v4/app/NotificationCompat$Builder;->mStyle:Landroid/support/v4/app/NotificationCompat$Style;
...
a=0;//     move-object/from16 v0, v20
a=0;// 
a=0;//     iget-object v6, v0, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mBigLargeIcon:Landroid/graphics/Bitmap;
a=0;// 
a=0;//     move-object/from16 v0, v20
a=0;// 
a=0;//     iget-boolean v7, v0, Landroid/support/v4/app/NotificationCompat$BigPictureStyle;->mBigLargeIconSet:Z
a=0;// 
a=0;//     #v7=(Boolean);
a=0;//     invoke-virtual/range {v1 .. v7}, Landroid/support/v4/app/NotificationCompatJellybean;->addBigPictureStyle(Ljava/lang/CharSequence;ZLjava/lang/CharSequence;Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Z)V
a=0;// 
a=0;//     goto :goto_1
a=0;// .end method
}}
